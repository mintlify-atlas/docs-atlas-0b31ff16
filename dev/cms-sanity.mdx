---
title: "Sanity CMS: Esquemas de Contenido y GROQ Queries"
sidebarTitle: "Sanity CMS"
description: "Guía del CMS Sanity headless: esquemas blogPost, noticia, author y tag, queries GROQ desde src/lib/queries.ts, y funciones de imagen sanityImg/sanitySrcset."
---
...
export function sanityImg(
  ...
  params.set('auto', 'format')          // WebP/AVIF según soporte del navegador
  params.set('q', String(opts.q ?? 75)) // Calidad por defecto: 75
...
<Tabs>
  ...
  <Tab title="noticia">
    ...
    defineType({
      ...
      fields: [
        ...
        { name: 'slug',        type: 'slug',   /* source: title, max:96 */ },
        { name: 'date',        type: 'date',   /* required */ },
  ...
  <Tab title="author">
    ...
    defineType({
      ...
      fields: [
        ...
        { name: 'slug',      type: 'slug',   /* source: name — ej: ximena-ugarte */ },
        { name: 'role',      type: 'string', /* placeholder: Directora y Fundadora */ },
  ...
  <Tab title="tag">
    ...
    defineType({
      ...
      fields: [
        { name: 'name', type: 'string', /* required */ },
        { name: 'slug', type: 'slug',   /* source: name, max:96 */ },
      ],
    })
    ```
  </Tab>
